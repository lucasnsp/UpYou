...
protocol TesouroIpcaScreenDelegate: AnyObject {
    func tappedBackButton()
}

class TesouroIpcaScreen: UIView {
    
    private weak var delegate: TesouroIpcaScreenDelegate?
    
    public func delegate(delegate: TesouroIpcaScreenDelegate?) {
