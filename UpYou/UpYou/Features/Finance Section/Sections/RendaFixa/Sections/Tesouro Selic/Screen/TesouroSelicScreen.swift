...
protocol TesouroSelicScreenDelegate: AnyObject {
    func tappedBackButton()
}

class TesouroSelicScreen: UIView {

    private weak var delegate: TesouroSelicScreenDelegate?
    
    public func delegate(delegate: TesouroSelicScreenDelegate?) {
