...
protocol LcaScreenDelegate: AnyObject {
    func tappedBackButton()
}

class LcaScreen: UIView {
    
    private weak var delegate: LcaScreenDelegate?
    
    public func delegate(delegate: LcaScreenDelegate?) {
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(LCATableViewCell.self, forCellReuseIdentifier: LCATableViewCell.identifier)
