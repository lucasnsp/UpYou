...
protocol FiisScreenDelegate: AnyObject {
    func tappedBackButton()
}

class FiisScreen: UIView {
    
    private weak var delegate: FiisScreenDelegate?
    
    public func delegate(delegate: FiisScreenDelegate?) {
