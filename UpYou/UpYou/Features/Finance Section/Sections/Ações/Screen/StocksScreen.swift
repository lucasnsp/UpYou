...
protocol StocksScreenDelegate: AnyObject {
    func tappedBackButton()
}

class StocksScreen: UIView {
    
    private weak var delegate: StocksScreenDelegate?
    
    public func delegate(delegate: StocksScreenDelegate?) {
