...
protocol CriptoScreenDelegate: AnyObject {
    func tappedBackButton()
}

class CriptoScreen: UIView {
    
    private weak var delegate: CriptoScreenDelegate?
    
    public func delegate(delegate: CriptoScreenDelegate?) {
