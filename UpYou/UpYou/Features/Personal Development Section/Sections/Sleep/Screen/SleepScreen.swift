...
protocol SleepScreenDelegate: AnyObject {
    func tappedBackButton()
}

class SleepScreen: UIView {
    
    private weak var delegate: SleepScreenDelegate?
    
    public func delegate(delegate: SleepScreenDelegate?) {
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(SleepTableViewCell.self, forCellReuseIdentifier: SleepTableViewCell.identifier)
